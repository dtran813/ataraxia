            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <SlideIn direction="up" delay={0.3}>
                <Card className="p-8 text-center group hover:shadow-lg transition-all duration-300 border-0 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Track your productivity habits and focus trends with
                  ...
                  <SlideIn direction="left" delay={0.1}>
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-300">
                          Start focusing immediately without creating an
                          account. Your preferences are saved locally.
                        </p>
                      </div>
                    </div>
                  </SlideIn>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <FadeIn duration={0.8}>
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
                Join thousands of professionals who use Ataraxia to enhance
